...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mitchelvanamstel/btcutilG/txsort)
...
```bash
$ go get -u github.com/mitchelvanamstel/btcutilG/txsort
```
