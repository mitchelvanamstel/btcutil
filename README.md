...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mitchelvanamstel/btcutilI)
...
```bash
$ go get -u github.com/mitchelvanamstel/btcutilI
```
