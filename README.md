...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mitchelvanamstel/btcutilH)
...
```bash
$ go get -u github.com/mitchelvanamstel/btcutilH
```
